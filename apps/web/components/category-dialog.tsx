...
export function CategoryDialog() {
	...
	const {
		...
		set_confirmation_dialog_delete_category_hidden:
			setConfirmationDialogDeleteCategoryHidden,
				...
				<form onSubmit={handleSubmit(onSubmit)} className="contents">
						...
						{type === "delete" ?
							<div className="flex flex-col gap-4">
								...
								<div className="flex items-center gap-2 pt-1">
									...
									/>
									<Label htmlFor={cascadeDeleteCheckboxId}>
										Also delete all transactions in this
										category.
									</Label>
								</div>
								<div className="flex items-center gap-2 pt-1">
									...
									/>
									<Label htmlFor={dontShowAgainCheckboxId}>
					...
					<DialogFooter className="border-t p-3">
						...
						<Button
							...
							onClick={
								type === "delete" ? handleDelete : undefined
							}
							disabled={type === "update" ? !isDirty : false}
							variant={
								type === "delete" ? "destructive" : "default"
							}
