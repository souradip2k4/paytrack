...
export const metadata: Metadata = {
	title: "Free Invoice Generator - Create & Share Invoices Online | Budgetbee",
	description:
		...
		<div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
			<section className="mb-8 space-y-2 sm:mb-10">
				...
				<p className="text-muted-foreground max-w-2xl text-base leading-7">
					...
					customise colors, add line items, then download a PDF or share
					a link. Drafts and templates stay on your device.
				</p>
			</section>
			...
			<section className="mt-14 space-y-6">
				...
				<div className="text-muted-foreground space-y-4 text-base leading-7">
					<p>
						...
						line items with quantities and prices, show subtotal, tax
						and the final amount due, and include a payment deadline.
						Adding a unique invoice number and date helps with
						bookkeeping on both sides.
					</p>
					<p>
						Save the doc as a template once and the next invoice for
						the same client takes seconds. Use the share link to send a
						lightweight preview without an email attachment.
					</p>
				</div>
			</section>
			...
			<CTACardOne
				...
				description="Budgetbee helps you keep income, expenses and pending payments in one clean view."
			/>
		</div>
	);
}
